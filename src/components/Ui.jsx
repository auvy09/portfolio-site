            ...
            <div className="container pt-14">
                <div className='md:flex items-center justify-between sm:flex-col md:flex-row'>
                    ...
                    <div className="w-full md:basis-1/2">
                        ...
                        <h1 data-aos="fade-up" data-aos-duration="1500" className='text-headingColor font-[800] text-[1.8rem] sm:text-[40px]leading-[30px] sm:leading-[46px]'>I'm Akib Al Mahmud Auvy<br />Frontend Developer</h1>
                        <div data-aos="fade-up" data-aos-duration="1900" data-aos-delay='200' className=' flex items-center gap-6 mt-7'>
                            ...
                            <a href="#project" className='text-smallTextColor font-[600] text-[16px] border-b border-solid border-smallTextColor'>See Portfolio</a>

                        </div>
                        <p data-aos="fade-left" data-aos-duration="1500" className='flex gap-2 text-headingColor font-[500] text-[15px] leading-7 mt-14 sm:pl-14 sm:pr-10'> <span><i class="ri-apps-2-fill"></i></span>A motivated undergraduate is eager to learn and gain experience.
